package com.netty.bootstrap.channel.cache;

import com.netty.auto.ConfigManager;
import com.netty.core.config.AutoConfig;
import com.netty.core.config.RedisConfig;
import com.netty.core.constant.UndefinedInChatConstant;
import com.netty.core.exception.LoginChannelNotFoundException;
import com.netty.core.utils.RedisUtil;
...
public class WebSocketCacheMap {
     ...
     * 存储用户标识与链接实例
     */
    private final static ConcurrentHashMap<String,Channel> channelByTokenMap = new ConcurrentHashMap<>();

    /**
     * 存储链接地址与用户标识
     */
    private final static ConcurrentHashMap<String,String> addressByTokenMap = new ConcurrentHashMap<>();
